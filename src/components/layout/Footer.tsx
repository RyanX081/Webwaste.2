...
export function Footer() {
  return (
    <footer className="relative mt-16 sm:mt-20 flow-ux__footer">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-24 left-1/3 h-48 w-48 -translate-x-1/2 rounded-full bg-emerald-400/20 blur-3xl" />
        <div className="absolute -bottom-24 right-1/4 h-56 w-56 translate-x-1/2 rounded-full bg-cyan-400/20 blur-3xl" />
      </div>
      <div className="relative mx-auto w-full max-w-[1220px] px-5 sm:px-6 lg:px-10">
        <div className="flow-ux__footer-columns">
          <div>
