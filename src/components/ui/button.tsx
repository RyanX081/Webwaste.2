...
const variantStyles: Record<ButtonVariant, string> = {
  primary: 'bg-emerald-600 text-white shadow-sm shadow-emerald-200/60 hover:bg-emerald-500 focus-visible:outline-emerald-600',
  secondary: 'bg-white text-slate-900 border border-slate-200 hover:border-emerald-400 hover:text-emerald-700 focus-visible:outline-slate-400',
